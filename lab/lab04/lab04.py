def divide(quotients, divisors):
    ...
    """
    return {quotient_in_order : [success_number for success_number in divisors if success_number % quotient_in_order == 0] for quotient_in_order in quotients}
...
def buy(fruits_to_buy, prices, total_amount):
    ...
    def add(fruits, amount, cart):
        if fruits == [] and amount == 0:
            ...
            fruit = fruits[0]
            price = prices[fruit]
            for k in range(1, (amount // prices[fruit] + 1)):
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    position = make_city('Potato Kingdom', lat, lon)
    distance_1 = distance(position, city_a)
    distance_2 = distance(position, city_b)
